...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Free Hosting Cpanel11 Auto Creat</title>
...
if (!empty($user_name)) {
  ...
  $params = "?plan={$whm_plan}&domain={$domain}&username={$username}&password={$password}&contactemail={$email}";
...
<div class="container">
<div class="demo-headline"><h1 class="demo-logo">CP11.HOST.GIAITRI24HOL.NET<small>Free Hosting Auto Creat</small></h1></div> 
